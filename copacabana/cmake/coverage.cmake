...
function(COPA_SETUP_COVERAGE target)
  ...
  if(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
    ...
    if(NOT LLVM_COV_EXECUTABLE)
      message(FATAL_ERROR
              "[${PROJECT_NAME}] - Coverage with Clang requires llvm-cov, install package llvm-${COMPILER_MAJOR}")
    endif()

    execute_process( COMMAND ${LLVM_COV_EXECUTABLE} --version
                     OUTPUT_VARIABLE COV_VERSION_OUTPUT OUTPUT_STRIP_TRAILING_WHITESPACE
                   )
  ...
  if(NOT CMAKE_MATCH_1 STREQUAL COMPILER_MAJOR)
    message(FATAL_ERROR
            "[${PROJECT_NAME}] - ${COV_TOOL_NAME} ${CMAKE_MATCH_1} cannot read notes written by "
  ...
  add_custom_target( ${OPT_PREFIX}-coverage-report
  ...
  add_custom_target( ${OPT_PREFIX}-coverage
                     COMMAND ${CMAKE_COMMAND} -DCOVERAGE_BUILD_DIR=${PROJECT_BINARY_DIR}
                                              -P "${COPACABANA_SOURCE_DIR}/copacabana/cmake/asset/reset_coverage.cmake"
