...
function(copa_sanitizer_flags out)
  ...
  elseif(CMAKE_CXX_COMPILER_ID MATCHES "MSVC")
    if(OPT_ENABLE_ASAN)
      ## /Z7 rather than /Zi: the debug information goes in the object files, so the targets built side by side do not
      ## write one PDB at once. Without it MSVC says C5072 and reports its findings with no symbol and no line.
      list(APPEND SANITIZER_FLAGS "/fsanitize=address" "/Z7")
    endif()
...
function(copa_setup_sanitizers target)
  ...
  if(SANITIZER_FLAGS)
    ...
    if(MSVC)
      ## /DEBUG turns the object debug information into a PDB the ASan runtime reads, which is LNK4302.
      target_link_options(${target} INTERFACE "/INCREMENTAL:NO" "/DEBUG")
    else()
