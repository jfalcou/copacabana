...
##==================================================================================================
function(COPA_MAKE_UNIT interface extension destination dependencies)
  foreach(file ${ARGN})
...
function(COPA_GLOB_UNIT)
  set(oneValueArgs  RELATIVE PATTERN INTERFACE EXTENSION DESTINATION)
  ...
  copa_make_unit(${OPT_INTERFACE} ${OPT_EXTENSION} ${OPT_DESTINATION} ${OPT_DEPENDENCIES} ${FILES})
endfunction()
